    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='core.studygroup')),
            ],
        ),
        migrations.CreateModel(
            name='ActivityLog',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action_type', models.CharField(choices=[('login', 'Login'), ('upload_file', 'Upload File'), ('create_topic', 'Create Topic'), ('delete_file', 'Delete File'), ('create_course', 'Create Course'), ('add_member', 'Add Member'), ('approve_group', 'Approve Group'), ('reject_group', 'Reject Group')], max_length=20)),
                ('description', models.TextField()),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to=settings.AUTH_USER_MODEL)),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activities', to='core.studygroup')),
            ],
        ),
        migrations.CreateModel(
            name='Topic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(choices=[('image', 'Image'), ('pdf', 'PDF'), ('code', 'Code'), ('other', 'Other')], default='other', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
